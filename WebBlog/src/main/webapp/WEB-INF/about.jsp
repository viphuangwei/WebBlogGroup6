		...
		<!-- <div class="row">
			<div class="box">
				...
				<div class="col-sm-4 text-center">
					<img class="img-responsive img-center" src="resources/img/ted.jpg"
						alt="">
					<h3>
						Tewodros Agedew <small>Developer</small>
					</h3>
				</div>
				<div class="col-sm-4 text-center">
					<img class="img-responsive img-center" src="" alt="">
					<h3>
						EnterPrise Architecture <small>MuM Activites </small>
					</h3>
				</div>
				<div class="col-sm-4 text-center">
					<img class="img-responsive img-center"
						src="resources/img/fiker.jpg" alt="">
					<h3>
						Fikereselam Elala <small>Developer</small>
					</h3>
				</div>
				<div class="clearfix"></div>
